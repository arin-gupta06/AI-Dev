...
# ═══════════════════════════════════════════════════════════════════════════════════
# ╔═══════════════════════════════════════════════════════════════════════════════╗
# ║              LINEAR REGRESSION MODEL - E-COMMERCE RATING PREDICTION          ║
# ║                                                                               ║
# ╚═══════════════════════════════════════════════════════════════════════════════╝
# ═══════════════════════════════════════════════════════════════════════════════════

print("\n" + "="*80)
print("LINEAR REGRESSION MODEL TRAINING".center(80))
print("="*80)
...
model.fit(x_train_stnd, y_train)
...
plt.subplot(1, 2, 1)
plt.scatter(sample_index, y_pred, label="Predicted", alpha=0.6, color='blue')
...
print("\n" + "="*80)
print("✨ LINEAR REGRESSION MODEL TRAINING COMPLETE ✨".center(80))
print("="*80 + "\n")
